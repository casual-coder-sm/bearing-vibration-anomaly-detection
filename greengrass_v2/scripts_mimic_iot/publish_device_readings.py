...
#Test Configuration
#######################################################################
print('ENV select_data_set = ',os.environ['select_data_set'])
print('ENV select_bearing = ',os.environ['select_bearing'])
print('ENV select_input_stepsize = ',os.environ['select_input_stepsize'])

select_data_set = int(os.environ['select_data_set']) - 1
select_bearing = int(os.environ['select_bearing']) - 1
select_input_stepsize= int(os.environ['select_input_stepsize'])
file_index = 0
...
for file_index, filename in enumerate(file_names_list[select_data_set][::select_input_stepsize]):
